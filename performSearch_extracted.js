async function performSearch() {
    ...
    if (results.length >= 200) {
        ...
        resultsContainer.insertAdjacentHTML('beforeend', '<div style="text-align:center; padding:1.5rem; margin-top:1rem; border-top:1px solid var(--border); color:var(--text-muted);">邃ｹ・・邨先棡縺悟､壹☆縺弱ｋ縺溘ａ縲∽ｸ贋ｽ・00件縺ｮ縺ｿ繧定｡ｨ遉ｺ縺励※縺・∪縺吶ゅ＆繧峨↓譚｡件繧堤ｵ槭ｊ霎ｼ繧薙〒縺上□縺輔＞縲・/div>');
        ...
        let boxHtml = `
            ...
            <div class="product-box">
                ...
                <div class="product-header">
                    ...
                    ${(p.name === 'Unregistered') ? `<button class="btn btn-secondary" style="margin-left: 1rem; padding: 2px 8px; font-size: 0.85rem;" onclick="registerProductName('${escapeHtml(pCode).replace(/'/g, "\\\\'")}')">陬ｽ品名繧堤匳骭ｲ縺吶ｋ</button>` : ''}
        ...
        if (group.boms && group.boms.length > 0) {
            ...
            boxHtml += `
                ...
                <div class="section">
                    ...
                    <div class="section-header" onclick="this.parentElement.classList.toggle('open')">
                        ...
                        <span>�搭 BOM (${group.boms.length}件)</span>
            ...
            group.boms.forEach(b => {
                ...
                if (b.components && b.components.length > 0) {
                    ...
                    compsHtml = `<div class="table-wrap"><table><tr><th>役割</th><th>驛ｨ蜩∫分蜿ｷ</th><th>品名(繝槭せ繧ｿ)</th><th>莉墓ｧ・繝槭せ繧ｿ)</th><th>仕様メモ</th></tr>`;
                        ...
                        b.components.forEach(c => {
                            ...
                            compsHtml += `<tr style="${style}">
                                ...
                                <td>
                                    ...
                                    ${c.master ? '<span title="繝槭せ繧ｿ邏蝉ｻ倥￠貂・ style="color:#20c997; margin-left:4px; font-size:14px;">�迫</span>' : '<span title="譛ｪ邏蝉ｻ倥￠" style="color:#e74c3c; margin-left:4px; font-size:14px;">未/span>'}
                ...
                boxHtml += `
                    ...
                    <div class="item-card">
                        ...
                        <div class="action-bar">
                            ...
                            ${b.sp_url ? `<a href="${b.sp_url}" target="_blank" class="btn btn-primary" style="background:#0078d4; border-color:#0078d4;">�倹 繝悶Λ繧ｦ繧ｶ縺ｧ開く (Excel for Web)</a>` : (b.file ? `<a href="/${b.file.replace(/\\/g, '/').split('/').map(encodeURIComponent).join('/')}" target="_blank" class="btn btn-secondary">Excelを開く/a>` : '')}
            ...
            boxHtml += `
                ...
                <div class="section">
                    ...
                    <div class="section-header" onclick="this.parentElement.classList.toggle('open')">
                        ...
                        <span>�統 蜉�蟾･萓晞�ｼ譖ｸ (${group.requests.length}件)</span>
                ...
                boxHtml += `
                    ...
                    <div class="item-card ${isModified ? 'highlight-modified' : ''}">
                        ...
                        <div class="action-bar">
                            ...
                            ${r.sp_url ? `<a href="${r.sp_url}" target="_blank" class="btn btn-primary" style="background:#0078d4; border-color:#0078d4;">�倹 繝悶Λ繧ｦ繧ｶ縺ｧ開く (Excel for Web)</a>` : (r.file ? `<a href="/${r.file.replace(/\\/g, '/').split('/').map(encodeURIComponent).join('/')}" target="_blank" class="btn btn-secondary">Excel/逕ｻ蜒上ｒ開く</a>` : '')}

                            ${r.is_handwritten ? `<button class="btn btn-secondary" onclick="updateHinmei('${escapeHtml(r.request_no)}', '${escapeHtml(r.hinmei)}')">品名繧堤ｷｨ髮・/button>` : ''}
             ...
             boxHtml += `
                ...
                <div class="section">
                    ...
                    <div class="section-header" onclick="this.parentElement.classList.toggle('open')">
                        ...
                        <span>笨・讀懈渊險ｼ (${group.inspections.length}件)</span>
                ...
                boxHtml += `
                    ...
                    <div class="item-card">
                        ...
                        <div class="action-bar">
                            ...
                            ${i.sp_url ? `<a href="${i.sp_url}" target="_blank" class="btn btn-primary" style="background:#0078d4; border-color:#0078d4;">�倹 繝悶Λ繧ｦ繧ｶ縺ｧ開く (Excel for Web)</a>` : (i.file_path ? `<a href="/${i.file_path.replace(/\\/g, '/').split('/').map(encodeURIComponent).join('/')}" target="_blank" class="btn btn-secondary">開く</a>` : '')}
             ...
             boxHtml += `
                ...
                <div class="section">
                    ...
                    <div class="section-header" onclick="this.parentElement.classList.toggle('open')">
                        ...
                        <span>�萄 蜀咏悄 (${group.photos.length}件)</span>
            ...
            boxHtml += `
               ...
               <div class="section">
                   ...
                   <div class="section-header" onclick="this.parentElement.classList.toggle('open')">
                       ...
                       <span>�盗 蝗ｳ髱｢ (${group.drawings.length}件)</span>
               ...
               boxHtml += `
                   ...
                   <div class="item-card">
                       ...
                       <div class="action-bar">
                           ...
                           ${d.sp_url ? `<a href="${d.sp_url}" target="_blank" class="btn btn-primary" style="background:#0078d4; border-color:#0078d4;">�倹 繝悶Λ繧ｦ繧ｶ縺ｧ開く (SharePoint)</a>` : ''}

                          ${d.file_path ? `<a href="/${d.file_path.replace(/\\/g, '/').split('/').map(encodeURIComponent).join('/')}" target="_blank" class="btn btn-secondary">繝ｭ繝ｼ繧ｫ繝ｫ縺ｧ開く</a>` : ''}
...
function renderRequestSearch(groups, tokens) {
    ...
    statsContainer.textContent = `蜉�蟾･萓晞�ｼ譖ｸ: ${totalFound}件隕九▽縺九ｊ縺ｾ縺励◆${totalFound > 100 ? ' (譛譁ｰ100件繧定｡ｨ遉ｺ)' : ''}`;
        ...
        let boxHtml = `
            ...
            <div class="product-group">
                ...
                <div class="group-header">
                    ...
                    <p style="margin: 0.5rem 0 0 0; font-size: 0.95rem; color: #cbd5e1;">品名: ${highlight(r.hinmei, tokens)} | 繧ｵ繧､繧ｺ: ${escapeHtml(r.size)}</p>
                    ...
                    <div class="item-card ${isModified ? 'highlight-modified' : ''}" style="border: 2px solid var(--primary); margin-bottom: 1rem;">
                        ...
                        <div class="table-wrap" style="margin-bottom:0.5rem">
                            ...
                            <table>
                                ...
                                <tr><th>品名</th><td>${highlight(r.hinmei, tokens)}</td><th>謨ｰ驥・/th><td>${highlight(r.qty, tokens)}</td></tr>
            ...
            boxHtml += `
                ...
                <div class="section">
                    ...
                    <div class="section-header" onclick="this.parentElement.classList.toggle('open')">
                        ...
                        <span>�搭 髢｢騾｣BOM (${box.boms.length}件)</span>
            ...
            boxHtml += `
                ...
                <div class="section">
                    ...
                    <div class="section-header" onclick="this.parentElement.classList.toggle('open')">
                        ...
                        <span>�剥 髢｢騾｣讀懈渊險ｼ (${box.inspections.length}件)</span>
            ...
            boxHtml += `
                ...
                <div class="section">
                    ...
                    <div class="section-header" onclick="this.parentElement.classList.toggle('open')">
                        ...
                        <span>�胴 髢｢騾｣蜀咏悄繝ｻ縺昴・莉・(${box.photos.length}件)</span>
            ...
            boxHtml += `
                ...
                <div class="section">
                    ...
                    <div class="section-header" onclick="this.parentElement.classList.toggle('open')">
                        ...
                        <span>�盗 髢｢騾｣蝗ｳ髱｢ (${box.drawings.length}件)</span>
...
function renderGlobalSearch(groups, tokens, state) {
    ...
    if (showBom && allBoms.length > 0) {
        ...
        html += `<div class="flat-section"><h3>�搭 BOM荳隕ｧ (${allBoms.length}件)</h3>`;
        ...
        allBoms.forEach(b => {
            ...
            if (b.components && b.components.length > 0) {
                ...
                compsHtml = `<div class="table-wrap" style="margin-bottom:1rem"><table><tr><th>役割</th><th>驛ｨ蜩∫分蜿ｷ</th><th>仕様メモ</th></tr>`;
            ...
            html += `
                ...
                <div class="item-card">
                    ...
                    <p style="margin:0 0 0.5rem 0; font-size:0.85rem; color:var(--text-muted)">
                        ...
                        陬ｽ逡ｪ: ${highlight(b.seiban, tokens)} | 品名: ${highlight(b._product && b._product.name, tokens)}
...
// Render Inspections Flat
    ...
    if (showInsp && allInsps.length > 0) {
        ...
        html += `<div class="flat-section"><h3>�剥 讀懈渊險ｼ荳隕ｧ (${allInsps.length}件)</h3><div style="display:flex; flex-wrap:wrap; gap:1rem">`;
    ...
    if (showPhoto && allPhotos.length > 0) {
        ...
        html += `<div class="flat-section"><h3>�胴 蜀咏悄繝ｻ縺昴・莉紋ｸ隕ｧ (${allPhotos.length}件)</h3><div style="display:flex; flex-wrap:wrap; gap:1rem">`;
    ...
    if (showDrawing && allDrawings.length > 0) {
        ...
        html += `<div class="flat-section"><h3>�盗 蝗ｳ髱｢荳隕ｧ (${allDrawings.length}件)</h3><div style="display:flex; flex-wrap:wrap; gap:1rem">`;
            ...
            html += `
                ...
                <div class="item-card" style="flex:1; min-width:250px">
                    ...
                    <div class="action-bar">
                        ...
                        ${d.file_path ? `<a href="/${d.file_path.replace(/\\/g, '/').split('/').map(encodeURIComponent).join('/')}" target="_blank" class="btn btn-secondary">繝繧ｦ繝ｳ繝ｭ繝ｼ繝・/ 開く</a>` : ''}
